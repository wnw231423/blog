...
- 项目：
	- [CMU 15-445 Fall 2025 Project 1: Buffer Pool Manager](https://15445.courses.cs.cmu.edu/fall2025/project1/)
	- [CMU 15-445 Fall 2025 Project 2: B+ Tree](https://15445.courses.cs.cmu.edu/fall2025/project2/)
...
3. `noexcept`，用于指示一个函数绝对不会抛出异常，这个肯定也是保证正确的情况下多用，最低也能作为函数 specification 的一部分，但这个说实话让我自己来写我可能很难想到去用这个关键字。可以参考 *Effective Modern C++* 的 Item 14 一章。
