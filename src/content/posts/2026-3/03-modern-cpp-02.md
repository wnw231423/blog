...
参考 _Effective Modern C++_ Item 10.
...
参考 _Effective Modern C++_ Chapter 4, Item 18 ~ 21
...
无论是从软件工程, 异常安全还是程序效率的角度, 使用`std::make_unique<T>()`和`std::make_shared<T>()`都是更好的选择. 在多数情境下, 我并不关心异常安全和程序效率, 所以细节就不在此展开, 可以参考 _Effective Modern C++_ 和其他资料.
